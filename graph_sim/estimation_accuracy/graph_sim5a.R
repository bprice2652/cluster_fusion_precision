...
## This file runs replications 1-25
...
library(simone)
#######
## NOTE YOU NEED TO MAKE SURE THE FILE PATH TO CLUSTER DA is correct.  It's in the
## beggining of the file path provided with this code. 
###
source("cluster_da.R")
...
p1=paste(method,p,l1,setting,"a.RData",sep="")
save.image(p1)
