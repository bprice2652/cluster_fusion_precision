...
option_list = list(
make_option(c("-p", "--ps"), type="numeric", default=1,
help="number of variables", metavar="number"),
make_option(c("-eps", "--eps"),type="numeric",default=1,
help="eps", metavar="number")
);

## This is to read an array job for the HPC system at WVU.
