...
option_list = list(
make_option(c("-p", "--p"), type="numeric", default=1,
help="number of variables", metavar="number"),
make_option(c("-r", "--r"),type="numeric",default=1,
help="r4", metavar="number")
);


## Above code reads in parameters from Array job on WVU HPC.
## p is 20,50 or 100
## r is .4,.47,or .5
...
## Need to source cluster da here
source("cluster_da.R")
##source("/scratch/bprice5/cluster_da.R")
##setwd("/scratch/bprice5/sim3")
